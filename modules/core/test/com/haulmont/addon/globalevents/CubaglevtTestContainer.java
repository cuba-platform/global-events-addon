...
public class CubaglevtTestContainer extends TestContainer {

    public CubaglevtTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addon/globalevents/app.properties",
    ...
    public static class Common extends CubaglevtTestContainer {

        public static final CubaglevtTestContainer.Common INSTANCE = new CubaglevtTestContainer.Common();
